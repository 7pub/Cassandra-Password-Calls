! function (e) {
	if ("object" == typeof exports && "undefined" != typeof module) module.exports = e();
		...
		var a;
		"undefined" != typeof window ? a = window : "undefined" != typeof global ? a = global : "undefined" != typeof self && (a = self), a.PwdThrem = e()
	}
}(function () {
	return function e(a, r, o) {
		...
		3: [function (e, a, r) {
			a.exports = {
			common: {/**Weltweite Verbreitung */
				name:"", 
				info:"",
				message:
				"<div class='card border-secondary mb-3 text-left' style='max-width: 100%; margin:0px 20px 0px -20px'>"+
					"<div class='card-header bg-danger border-secondary text-left'></div>"+
						"<div class='card-body text-center'>"+
							"<h5 class='card-title' style='display: inline'>"+
								"<i class='fas fa-trophy fa-2x' style='color:steelblue'></i>"+
							"</h5>"+
							"<h5 style='display: inline-block;vertical-align: middle;width: 70%;'>"+
								"<em class='text-danger'>&nbsp;&nbsp;Warnung: Meistgenutztes Passwort! Schweres Sicherheitsrisiko gefunden!</em>"+
							"</h5>"+
							"<hr/>"+
							"<p class='card-text' style='color:steelblue'>Es belegt &#34;Platz {{ value }}&#34; von den am meist genutzten Kennwörtern.<br/>Du solltest es auf gar keinen Fall verwenden oder jetzt sofort ändern!</p>"+
						"</div>"+
			...
			karlachleitner : {/**Easter Egg */
				name: "<span class='PwdThrem-Easteregg-KarlAchleitner'>Easteregg found! Karl</span>",
				info: "<span class='PwdThrem-Easteregg-KarlAchleitner-Info'>Es gibt immer eine Hintertür...</span>",
				message: "<span class='PwdThrem-Easteregg-KarlAchleitner-Message'>Der Typ der diese Software geschrieben hat wurde Karl, Paranoid-Karli gennant.<br>Er ist geboren im ersten Paradox von Paranoia, Neuzehn-para-siebenundsiebzig-noid.</span>"
			},
			sandrawöckinger: {/**Easter Egg */
				name: "<span class='PwdThrem-Easteregg-SandraWöckinger'>Easteregg found! Sandra</span>",
				info: "<span class='PwdThrem-Easteregg-SandraWöckinger-Info'>Es gibt immer eine Hintertür...</span>",
				message: "<span class='PwdThrem-Easteregg-SandraWöckinger-Message'>Die alte des Typen der diese Software geschrieben hat. Sie wurde nicht nur Sandi, Paranoid-Sanni gennant.<br>Sie ist das Paradox im ersten Paranoia!</span>"
			},
			rikiwöckinger: {/**Easter Egg */
				name: "<span class='PwdThrem-Easteregg-RikiWöckinger'>Easteregg found! Riki</span>",
				info: "<span class='PwdThrem-Easteregg-RikiWöckinger-Info'>rikiwöckinger</span>",
				message:"<span class='PwdThrem-Easteregg-RikiWöckinger-Message'>Das Copy zum Paste für die Alte des Typen, der diese Software geschrieben hat.</span>"
			},
			helmutwöckinger: {/**Easter Egg */
				name: "<span class='PwdThrem-Easteregg-HelmutWöckinger'>Easteregg found! Heli</span>",
				info: "<span class='PwdThrem-Easteregg-HelmutWöckinger-Info'>helmutwöckinger</span>",
				message:"<span class='PwdThrem-Easteregg-HelmutWöckinger-Message'>Das Y Chromosom für die Erstellung der Alten des Typen, der diese Software geschrieben hat. Auch Schrebergarten-Agassi genannt.</span>"
			},
			tanjahaslinglehner: {/**Easter Egg */
				name: "<span class='PwdThrem-Easteregg-TanjaHaslinglehner'>Easteregg found! Tanja</span>",
				info: "<span class='PwdThrem-Easteregg-TanjaHaslinglehner-Info'>tanjahaslinglehner</span>",
				message:"<span class='PwdThrem-Easteregg-TanjaHaslinglehner-Message'>Die SEIFEN-Oper Queen.</span>"
			},
			manuelhaslinglehner: {/**Easter Egg */
				name: "<span class='PwdThrem-Easteregg-ManuelHaslinglehner'>Easteregg found! Manuel</span>",
				info: "<span class='PwdThrem-Easteregg-ManuelHaslinglehner-Info'>manuelhaslinglehner</span>",
				message:"<span class='PwdThrem-Easteregg-ManuelHaslinglehner-Message'>Der Oli.P unter den möchtegern Jimmy Hendrix</span>"
			},
			leawöckinger: {/**Easter Egg */
				name: "<span class='PwdThrem-Easteregg-LeoWöckinger'>Easteregg found! Lea</span>",
				info: "<span class='PwdThrem-Easteregg-LeoWöckinger-Info'>leawöckinger</span>",
				message:"<span class='PwdThrem-Easteregg-LeoWöckinger-Message'>Oder auch: Chrisu - wenn ich groß bin werd ich Feuerwehrmann!</span>"
			},
			lengthVeryShort: {/**Zeichenanzahl */
				name:"",
				info:"",
				message:
				"<div class='card border-secondary mb-3 text-left' style='max-width: 100%; margin:0px 20px 0px -20px'>"+
				"<div class='card-header bg-danger border-secondary text-left'></div>"+
					"<div class='card-body text-center'>"+
						"<h5 class='card-title' style='display: inline'>"+
							"<i class='fas fa-sort-amount-down fa-2x' style='color:steelblue'></i>"+
						"</h5>"+
						"<h5 style='display: inline-block;vertical-align: middle;width: 70%;'>"+
							"<em class='text-danger'>&nbsp;&nbsp;Diese Tüte hat nichts zu bieten!<br/>Wieso ist dein Passwort so kurz?</em>"+
						"</h5>"+
						"<hr/>"+
						"<p class='card-text' style='color:steelblue'>Ich denke nicht das ich dir erklären muss dass ein längeres Kennwort mehr Sicherheit bietet. Ich frage mich warum du ein derart kurzes Passwort verwenden willst. Muss ich mir Sorgen machen?<br/><em class='text-secondary'>Hinweis: Ein Account mit einem derat kurzen Kennwort wird in kürzester Zeit geknackt und Du bekommst nichts davon mit!</em></p>"+
					"</div>"+
				"<div class='card-footer bg-transparent border text-right'>lengthVeryShort</div>"+
			  "</div>"
			},
			justLetters: {/**Abwechlungswarnung */
				name:"",
				info:"",
				message:
				"<div class='card border-secondary mb-3 text-left' style='max-width: 100%; margin:0px 20px 0px -20px'>"+
				"<div class='card-header bg-danger border-secondary text-left'></div>"+
					"<div class='card-body text-center'>"+
						"<h5 class='card-title' style='display: inline'>"+
						"<i class='fas fa-paragraph fa-2x' style='color:steelblue'></i>"+
						"</h5>"+
						"<h5 style='display: inline-block;vertical-align: middle;width: 70%;'>"+
							"<em style='color:#fc7600'>&nbsp;&nbsp;Nur Buchstaben sind nicht nur langweilig, sonder sehr gefährlich!</em>"+
						"</h5>"+
						"<hr/>"+
						"<p class='card-text' style='color:steelblue'>.<br/><em class='text-secondary'></em>Es gibt Indizien für die Existenz von weiterführenden Zeichen die neben den bekannten Buchstaben als Ergänzung zum Passwort hinzugefügt werden können.</p>"+
					"</div>"+
				"<div class='card-footer bg-transparent border text-right'>justLetters</div>"+
			  "</div>"
			},
			possiblyWord: {/**Grimm Verstoß */
				name:"",
				info:"",
				message:
				"<div class='card border-secondary mb-3 text-left' style='max-width: 100%; margin:0px 20px 0px -20px'>"+
				"<div class='card-header border-secondary text-left' style='background-color:#fc7600'></div>"+
					"<div class='card-body text-center'>"+
						"<h5 class='card-title' style='display: inline'>"+
							"<i class='fas fa-pen-nib fa-2x' style='color:steelblue'></i>"+
						"</h5>"+
						"<h5 style='display: inline-block;vertical-align: middle;width: 70%;'>"+
							"<em style='color:#fc7600'>&nbsp;&nbsp;Vermeide Übereinstimmungen zu sogenannten Wortlisten.</em>"+
						"</h5>"+
						"<hr/>"+
						"<p class='card-text' style='color:steelblue'>Worterkennungssyteme berücksichtig ebenfalls häufige gesehene Rechtschreibfehler.<br/><em class='text-secondary'>Angreifer benutzen &#34;Wortlisten&#34; um völlig automatisiert Accounts mit solchen Kennwörtern aufspüren und knacken.</em></p>"+
					"</div>"+
				"<div class='card-footer bg-transparent border text-right'>possiblyWord</div>"+
			  "</div>"
			},
			onlyNumbers: {/**Abwechslungswarnung */
				name:"",
				info:"",
				message:
				"<div class='card border-secondary mb-3 text-left' style='max-width: 100%; margin:0px 20px 0px -20px'>"+
				"<div class='card-header border-secondary text-left' style='background-color:#fc7600'></div>"+
					"<div class='card-body text-center'>"+
						"<h5 class='card-title' style='display: inline'>"+
							"<i class='fas fa-list-ol fa-2x' style='color:steelblue'></i>"+
						"</h5>"+
						"<h5 style='display: inline-block;vertical-align: middle;width: 70%;'>"+
							"<em style='color:#fc7600'>&nbsp;&nbsp;Ausschliesslich Nummer als Kombination ist absolut nicht empfehlenswert.<br/></em>"+
						"</h5>"+
						"<hr/>"+
						"<p class='card-text' style='color:steelblue'>Tausche ein Nur-Nummer-Kennwort ehestmöglich mit einer komplexen Kombination von Nummer/Buchstaben/Sonderzeichen.<br/><em class='text-secondary'></em></p>"+
					"</div>"+
				"<div class='card-footer bg-transparent border text-right'>onlyNumbers</div>"+
			  "</div>"
			},
			wordAndNumber: {/**Muster oder Anordnung */
				name:"",
				info:"",
				message:
				"<div class='card border-secondary mb-3 text-left' style='max-width: 100%; margin:0px 20px 0px -20px'>"+
				"<div class='card-header border-secondary text-left' style='background-color:#fc7600'></div>"+
					"<div class='card-body text-center'>"+
						"<h5 class='card-title' style='display: inline'>"+
							"<i class='fab fa-artstation fa-2x' style='color:steelblue'></i>"+
						"</h5>"+
						"<h5 style='display: inline-block;vertical-align: middle;width: 70%;'>"+
							"<em style='color:#fc7600'>&nbsp;&nbsp;Vermeide Muster in Passwörter.Dies ermöglicht Zielgruppen Analysen.</em>"+
						"</h5>"+
						"<hr/>"+
						"<p class='card-text' style='color:steelblue'>Dies wird durch das Zusammenfühen unterschiedlichen Datenpunkte erreicht.<br/>"+
						"<em class='text-secondary'>Mixe deine Passwörter noch ein wenig durch</em></p>"+
					"</div>"+
				"<div class='card-footer bg-transparent border text-right'>wordAndNumber</div>"+
			  "</div>"
			},
			lengthShort: {/**Zeichenanzahl */
				name:"",
				info:"",
				message:
				"<div class='card border-secondary mb-3 text-left' style='max-width: 100%; margin:0px 20px 0px -20px'>"+
				"<div class='card-header border-secondary text-left' style='background-color:#fc7600'></div>"+
					"<div class='card-body text-center'>"+
						"<h5 class='card-title' style='display: inline'>"+
							"<i class='fas fa-sort-alpha-down fa-2x' style='color:steelblue'></i>"+
						"</h5>"+
						"<h5 style='display: inline-block;vertical-align: middle;width: 70%;'>"+
							"<em style='color:#fc7600'>&nbsp;&nbsp;.</em>"+
						"</h5>"+
						"<hr/>"+
						"<p class='card-text' style='color:steelblue'>Empfohlen sind Passwörten mit mindestens einer Länge von 16 Zeichen. Rechne es dir selbst aus warum jedes Zeichen zählt.<br/>Ich weis es ist lässtig. Doch beantworte dir folgende Frage: Merkst du es wenn ein Fremder deinen Schlüssel hat?<em class='text-secondary'></em></p>"+
					"</div>"+
				"<div class='card-footer bg-transparent border text-right'>lengthShort</div>"+
			  "</div>"
			},
			noSymbols: {/**Warnung */
				name:"",
				...
				"<div class='card-header border-secondary text-left' style='background-color:#fc7600'></div>"+
					"<div class='card-body text-center'>"+
						"<h5 class='card-title' style='display: inline'>"+
							"<i class='fas fa-palette fa-2x' style='color:steelblue'></i>"+
						"</h5>"+
						"<h5 style='display: inline-block;vertical-align: middle;width: 70%;'>"+
							"<em style='color:#fc7600'>&nbsp;&nbsp;Du verwendest keine Symbole in deinem Passwort</em>"+
						"</h5>"+
						"<hr/>"+
						"<p class='card-text' style='color:steelblue'>Symbole in einem Passwort wirkern sich ungeheuerlich positiv auf die Sicherheit aus. Bedenke das auch die Leertaste verwnedet werden kann.<br/><em class='text-secondary'>Ich empfehle Dir all jene deiner Passwörter die ohne Symbole sind, durch Passwörtern mit Symbolen zu ersetzen.</em></p>"+
					"</div>"+
				"<div class='card-footer bg-transparent border text-right'>noSymbols</div>"+
			  "</div>"
			},
			telephone: {/**Anordnung oder Muster */
				name:"",
				info:"",
				message:
				"<div class='card border-secondary mb-3 text-left' style='max-width: 100%; margin:0px 20px 0px -20px'>"+
				"<div class='card-header border-secondary text-left' style='background-color:#fc7600'></div>"+
					"<div class='card-body text-center'>"+
						"<h5 class='card-title' style='display: inline'>"+
							"<i class='fab fa-# fa-2x' style='color:steelblue'></i>"+
						"</h5>"+
						"<h5 style='display: inline-block;vertical-align: middle;width: 70%;'>"+
							"<em style='color:#fc7600'>&nbsp;&nbsp;telephone.</em>"+
						"</h5>"+
						"<hr/>"+
						"<p class='card-text' style='color:steelblue'>.<br/><em class='text-secondary'></em></p>"+
					"</div>"+
				"<div class='card-footer bg-transparent border text-right'>telephone</div>"+
			  "</div>"
			},
			repeatedPattern: {/**Wiederholungswarnung */
				name:"",
				info:"",
				message:
				"<div class='card border-secondary mb-3 text-left' style='max-width: 100%; margin:0px 20px 0px -20px'>"+
				"<div class='card-header border-secondary text-left' style='background-color:#fc7600'></div>"+
					"<div class='card-body text-center'>"+
						...
						"</h5>"+
						"<h5 style='display: inline-block;vertical-align: middle;width: 70%;'>"+
							"<em style='color:#fc7600'>&nbsp;&nbsp;repeatedPattern.</em>"+
						"</h5>"+
						"<hr/>"+
						"<p class='card-text' style='color:steelblue'>.<br/><em class='text-secondary'></em></p>"+
					"</div>"+
				"<div class='card-footer bg-transparent border text-right'>repeatedPattern</div>"+
			  	"</div>"
			},
			nonStandardCharacters: {/**Abwechslung: Akzeptabel */
				name:"",
				info:"",
				message:
				"<div class='card border-secondary mb-3 text-left' style='max-width: 100%; margin:0px 20px 0px -20px'>"+
					"<div class='card-header border-secondary bg-success text-left'></div>"+
						"<div class='card-body text-center'>"+
							"<h5 class='card-title' style='display: inline'>"+
								"<i class='fab fa-# fa-2x' style='color:steelblue'></i>"+
							"</h5>"+
							"<h5 style='display: inline-block;vertical-align: middle;width: 70%;'>"+
								"<em style='color:#fc7600'>&nbsp;&nbsp;nonStandardCharacters.</em>"+
							"</h5>"+
							"<hr/>"+
							"<p class='card-text' style='color:steelblue'>.<br/><em class='text-secondary'></em></p>"+
						"</div>"+
					"<div class='card-footer bg-transparent border text-right'>nonStandardCharacters</div>"+
			  	"</div>"
			},
			lengthLong: {/**Länge: Akzeptabel */
				name:"",
				info:"",
				message:
				"<div class='card border-secondary mb-3 text-left' style='max-width: 100%; margin:0px 20px 0px -20px'>"+
					"<div class='card-header border-secondary bg-success text-left'></div>"+
						"<div class='card-body text-center'>"+
							...
							"</h5>"+
							"<h5 style='display: inline-block;vertical-align: middle;width: 70%;'>"+
								"<em style='color:#fc7600'>&nbsp;&nbsp;lengthLong.</em>"+
							"</h5>"+
							"<hr/>"+
							"<p class='card-text' style='color:steelblue'>.<br/><em class='text-secondary'></em></p>"+
						"</div>"+
					"<div class='card-footer bg-transparent border text-right'>lengthLong</div>"+
			  	"</div>"
			},
		}
		}, {}],
				...
				t = function (e) {
					if (o.hasOwnProperty(e.id)) {
						...
						return {
							...
							info: e.value ? a.info.replace("{{ value }}", e.value) : a.info,
		...
		8: [function (e, a, r) {
			a.exports = {
				...
				"^karlachleitner|geoff$": {
					level: "easteregg",
					id: "karlachleitner"
				},
				"^sandrawöckinger|geoff$": {
					level: "easteregg",
					id: "sandrawöckinger"
				},
				"^rikiwöckinger|geoff$": {
				...
				"^helmutwöckinger|geoff$": {
					level: "easteregg",
					id: "helmutwöckinger"
				},
				"^tanjahaslinglehner|geoff$": {
					level: "easteregg",
					id: "tanjahaslinglehner"
				},
				"^manuelhaslinglehner|geoff$": {
					level: "easteregg",
					id: "manuelhaslinglehner"
				},
				"^leawöckinger|geoff$": {
					level: "easteregg",
					id: "leawöckinger"
		...
		11: [function (e, a, r) {
			a.exports = function (a) {
				var r = e("./dictionary"),
					o = e("PwdThrem-period/period-dictionary"),
					n = e("PwdThrem-named-number/named-number-dictionary"),
					i = e("PwdThrem-checker/checker-dictionary");
				a.setDictionary(r), a.setPeriodDictionary(o), a.setNamedNumberDictionary(n), a.setCheckerDictionary(i), a.setCharacterSets(e("PwdThrem-character-sets/character-sets.json"));
				var s = e("PwdThrem-checks/checks/patterns"),
					t = e("PwdThrem-checks/checks/common");
				return s.setDictionary(e("PwdThrem-checks/dictionaries/patterns.json")), t.setDictionary(e("PwdThrem-checks/dictionaries/top10k.json")), a.setCheckerChecks([s, t]), a
			}
		}, {
			"./dictionary": 12,
			"PwdThrem-character-sets/character-sets.json": 1,
			"PwdThrem-checker/checker-dictionary": 3,
			"PwdThrem-checks/checks/common": 6,
			"PwdThrem-checks/checks/patterns": 7,
			"PwdThrem-checks/dictionaries/patterns.json": 8,
			"PwdThrem-checks/dictionaries/top10k.json": 9,
			"PwdThrem-named-number/named-number-dictionary": 14,
			"PwdThrem-period/period-dictionary": 16
		}],
		12: [function (e, a, r) {
			a.exports = {
				instantly: "Instantly",
		...
		13: [function (e, a, r) {
			...
			var o = e("PwdThrem-library"),
				n = null,
				i = {
					characterSets: e("PwdThrem-character-sets"),
					period: e("PwdThrem-period"),
					namedNumber: e("PwdThrem-named-number"),
					checker: e("PwdThrem-checker")
				},
				s = {
				...
				l = o.memoize(function (e) {
					if (!n) throw new Error("PwdThrem: dictionary not set");
					var a = {},
						r = i.characterSets(e),
			...
			"PwdThrem-character-sets": 2,
			"PwdThrem-checker": 4,
			"PwdThrem-library": 10,
			"PwdThrem-named-number": 15,
			"PwdThrem-period": 17
		}],
		14: [function (e, a, r) {
			a.exports = {
		...
		18: [function (e, a, r) {
			"use strict";
			var o = e("PwdThrem-main/bootstrap")(e("PwdThrem-main")),
				n = e("PwdThrem-library"),
				i = n.curry(function (e, a) {
					if (!a || !n.isFunction(a.click)) throw new Error("input not supplied");
					var r = a.getAttribute("class") + " PwdThrem-level",
					...
					a.setAttribute("class", r), o.setOptions(t), a.addEventListener("keyup", function () {
						var e = o(a.value);
						a.value.length ? (a.setAttribute("class", r + " PwdThrem-level--" + e.getSecurityLevel()), i(e.getString(), a), s(e.getChecks(), a)) : (a.setAttribute("class", r), i(!1, a), s([]))
					})
				});
